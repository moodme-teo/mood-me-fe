...
export default function GeneratingBoardAnimation({
  ...
  return (
    <div
      ...
      className="grid aspect-square grid-cols-3 gap-2 rounded-2xl border border-neutral-200 bg-neutral-50 p-3"
    >
      {SAMPLE_CARDS.map((card, i) => (
        <div
          key={card.id}
          className="relative overflow-hidden rounded-lg bg-neutral-200 transition-opacity duration-700"
