...
| 문서 | 내용 | 상태 |
| --- | --- | --- |
| [component.md](./component.md) | 배치(ui/features/canvas) · Server/Client · props · composition · import 규칙 | 🚧 초안 |
...
| [naming.md](./naming.md) | 파일명(kebab-case) · 식별자 · 용어사전 · toss 이름 규칙 | 🚧 초안 |
...
| 폴더 경계 (feature 간 · 단방향 · Konva 격리) | ESLint `import/no-restricted-paths` zones | 🔜 후속 이슈 |
| 파일명 kebab-case | ESLint `check-file` | 🔜 후속 이슈 |
